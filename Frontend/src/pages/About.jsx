    ...
    <div className="bg-light text-dark">
      ...
      >
        ...
        <Container style={{ zIndex: 2 }} className="text-white">
          ...
          <Button as={Link} to="/new" variant="primary" className="px-4 py-2">
      ...
      <Container className="py-5">
        <h2 className="text-center text-primary mb-5 display-5 fw-bold fs-2-5">Our Story</h2>
      ...
      <div className="bg-white py-5 border-top">
        <Container>
          <h2 className="text-center text-primary mb-5 display-5 fw-bold fs-2-5">
            Our Core Principles
          </h2>
      ...
      <Container className="text-center py-5">
        <h2 className="text-primary mb-4 display-5">
